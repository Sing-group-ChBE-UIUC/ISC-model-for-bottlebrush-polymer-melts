...
double calc_reedsq_bb(double **coords, int Nbb, int nchain, int natom_perchain, double box_size, int beg)
{
    double res = 0;
    double rx1, ry1, rz1;
    double rx2, ry2, rz2;
...
double calc_reedsq_sc(double **coords, int Nbb, int Nsc, int f_branch, int nchain, double box_size, int beg)
{
    double res = 0;
    double rx1, ry1, rz1;
    double rx2, ry2, rz2;
    ...
    for (i = 0; i < nchain; ++i)
    {
        for (j = 0; j < Nbb; ++j)
        {
            ...
            {
                sc_beg = beg+i * natom_perchain + Nbb + (j * f_branch + k) * Nsc;
                sc_end = sc_beg + Nsc - 1;
                rx1 = coords[sc_beg][0];
                ry1 = coords[sc_beg][1];
                rz1 = coords[sc_beg][2];
...
double calc_rgsq_bb(double **coords, int Nbb, int nchain, int natom_perchain, double box_size, int beg)
{
    double res = 0;
    double rg, rgsq;
    double rx, ry, rz;
...
double calc_rgsq_sc(double **coords, int Nbb, int Nsc, int f_branch, int nchain, double box_size, int beg)
{
    double res = 0;
    double rg, rgsq;
    double rx, ry, rz;
